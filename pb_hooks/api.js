...
const B = require(`${__hooks}/shared/barcode.js`);
...
// Barcode normalization (normUpc / upcACheck / upcEtoA / barcodeVariants) is shared verbatim with
// the Cloud edition — see core/src/shared/barcode.js, copied into the image at /pb/pb_hooks/shared/.
const normUpc = B.normUpc;
const upcEtoA = B.upcEtoA;
const barcodeVariants = B.barcodeVariants;
